...
export async function withStateLock(lockPath, fn, options = {}) {
...
export function withStateLockSync(lockPath, fn, options = {}) {
...
export function isStateLockTimeout(error) {
