...
export type CriteriaArgs = {
    readonly goalId: string;
};
export type CheckpointMutationArgs = CheckpointUlwLoopArgs & {
    readonly printTemplate?: false;
};
export type CheckpointTemplateArgs = {
    readonly printTemplate: true;
    readonly goalId?: string;
};
...
export type ToolkitDispatchRequest = {
    ...
    readonly operation: "create-goals";
    readonly args: CreateGoalsArgs;
} | {
    readonly operation: "status";
    readonly args?: Record<never, never>;
} | {
    readonly operation: "complete-goals";
    readonly args?: CompleteGoalsArgs;
} | {
    readonly operation: "checkpoint";
    readonly args: CheckpointArgs;
} | {
    readonly operation: "steer";
    readonly args: SteerArgs;
} | {
    readonly operation: "add-goal";
    readonly args: AddGoalArgs;
} | {
    readonly operation: "criteria";
    readonly args: CriteriaArgs;
} | {
    readonly operation: "record-evidence";
    readonly args: RecordEvidenceArgs;
} | {
    readonly operation: "record-review-blockers";
    readonly args: RecordReviewBlockersArgs;
};
...
} : Operation extends "record-evidence" ? Awaited<ReturnType<typeof recordEvidence>> : Operation extends "record-review-blockers" ? Awaited<ReturnType<typeof recordFinalReviewBlockers>> : never;
export type ToolkitResultFor<Operation extends UlwLoopOperation> = ResultFor<Operation>;
export type ToolkitResponseFor<Operation extends UlwLoopOperation> = ToolkitSuccess<Operation, ResultFor<Operation>> | ToolkitFailure<Operation>;
...
export interface ToolkitHostHooks {
    readonly onOperation?: <Operation extends UlwLoopOperation>(event: ToolkitOperationHookEvent<Operation>) => void | Promise<void>;
}
...
export interface AgentToolkit {
    ...
    readonly recordReviewBlockers: (args: RecordReviewBlockersArgs) => Promise<ToolkitResponseFor<"record-review-blockers">>;
}
export {};
