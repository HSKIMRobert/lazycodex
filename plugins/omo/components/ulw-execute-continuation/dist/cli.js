...
// components/ulw-execute-continuation/src/cli.ts
import { readFileSync as readFileSync4 } from "node:fs";
import { stdin as processStdin, stdout as processStdout } from "node:process";

// components/ulw-execute-continuation/src/boulder-reader.ts
import { existsSync as existsSync2, readFileSync as readFileSync2 } from "node:fs";
import { isAbsolute, join, relative, resolve } from "node:path";

// components/ulw-execute-continuation/src/plan-checklist.ts
...
// components/ulw-execute-continuation/src/directive.ts
import { readFileSync as readFileSync3 } from "node:fs";
var ULW_EXECUTE_CONTINUATION_DIRECTIVE = readFileSync3(new URL("../directive.md", import.meta.url), "utf8");

// components/ulw-execute-continuation/src/codex-hook.ts
...
var EXTERNAL_BLOCKER_MARKER = "<ulw-execute-blocked-external>";
